...
insert  into `payment_transactions`(`id`,`date`,`payment_method_id`,`partner_id`,`currency_id`,`amount`,`cancelled`,`cancel_note`) values (1,'2015-07-19 00:16:00',3,1,2,'0.02',1,'222');
insert  into `payment_transactions`(`id`,`date`,`payment_method_id`,`partner_id`,`currency_id`,`amount`,`cancelled`,`cancel_note`) values (2,'2015-07-19 00:16:00',3,1,1,'0.02',0,NULL);
insert  into `payment_transactions`(`id`,`date`,`payment_method_id`,`partner_id`,`currency_id`,`amount`,`cancelled`,`cancel_note`) values (3,'2015-07-19 00:16:00',3,1,1,'0.02',0,NULL);
...
CREATE TABLE `products` (
  ...
  `uom` int(11) DEFAULT '1' COMMENT 'Unit of Measurement',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
