...
namespace crm\loads\main\whishlist {
    ...
    class ListLoad extends AdminLoad {
        ...
        public function load() {
            ...
            $whishlist = WhishlistManager::getInstance()->selectAdvance('*', $where, $sortByFieldName, $selectedFilterSortByAscDesc, $offset, $limit);
            $count = WhishlistManager::getInstance()->getLastSelectAdvanceRowsCount();
            $this->addParam('whishlists', $whishlist);
            if (count($whishlist) == 0 && $count > 0) {
        ...
        public function getTemplate() {
            return NGS()->getTemplateDir() . "/main/whishlist/list.tpl";
        }
