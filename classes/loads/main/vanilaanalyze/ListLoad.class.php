...
namespace crm\loads\main\vanilaanalyze {
    ...
    class ListLoad extends AdminLoad {
        ...
        public static function initLoad($load) {
            ...
            list($totalConfirmedClothing, $totalPendingClothing) = VanillaCardsManager::getInstance()->getConfirmedAndPendigTransactionsTotalByTransactionNames(['Zara.com', 'OLD NAVY', 'carters', 'THECHILDRENSPLACE', 'WALMART', 'puma', 'ADIDAS', 'PATPAT'], $selectedFilterCalculationMonths, $telegramChatIdsSql);
            ['walmart', 'blinq', 'frys'];
        ...
        public function getTemplate() {
            return NGS()->getTemplateDir() . "/main/vanilaanalyze/list.tpl";
        }
