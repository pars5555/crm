...
namespace crm\dal\mappers {
    ...
    use crm\dal\dto\OnlineShopDto;

    class OnlineShopsMapper extends AdvancedAbstractMysqlMapper {

        private static $instance;
        public $tableName = "online_shops";

        public static function getInstance() {
            if (self::$instance == null) {
                self::$instance = new OnlineShopsMapper();
            }
