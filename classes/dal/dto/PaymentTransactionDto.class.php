...
namespace crm\dal\dto {
    ...
    class PaymentTransactionDto extends AbstractDto {
        ...
        private $mapArray = array("id" => "id", "date" => "date", "payment_method_id" => "paymentMethodId",
            "partner_id" => "partnerId", "currency_id" => "currencyId", "amount" => "amount"
            , "cancelled" => "cancelled", "cancel_note" => "cancelNote", "note" => "note", "signature" => "signature", "is_expense" => "isExpense", "paid" => "paid", "currency_rate" => "currencyRate"
        );
