    ...
    <div class="main-table">
        <table>
            ...
            {foreach from=$ns.products item=product}
                ...
                <tr {if $ns.productsQuantity[$product->getId()]<0 || $ns.pwarehousesProductsQuantity[$product->getId()]<0}style="background: yellow"{else}{if $product->getQtyChecked() == 1}style="background: lightgreen"{/if}{/if} 
