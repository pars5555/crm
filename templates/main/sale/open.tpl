...
<div class="table-row" id="saleOrderLineTemplate" style="display:none">
    ...
    <div class="table-cell">
        <input class="text" type="number" step="0.1"  min="0.1" class="saleOrderLinesSelectQuantity"/>
    </div>
    <div class="table-cell">
        <input class="text" type="number" step="0.01" min="0.01" class="saleOrderLinesSelectUnitPrice"/>
    </div>
    <div class="table-cell">
    </div>
    <div class="table-cell">
