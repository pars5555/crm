<div class="container whishlist--create--container">
    ...
    {if isset($ns.whishlist)}
        <form class="updateWhishlist create--form" autocomplete="off" method="post" action="{$SITE_PATH}/dyn/main_whishlist/do_update_whishlist">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="id" value="{$ns.whishlist->getId()}"/>
        </form>
    {else}
        Wrong Whishlist!
    {/if}
