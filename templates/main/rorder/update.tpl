<div class="container rorder--create--container">
    ...
    {if isset($ns.recipientOrder)}
        <form class="updateRecipientOrder create--form" autocomplete="off" method="post" action="{$SITE_PATH}/dyn/main_rorder/do_update_recipient_order">
    ...
    <input type="hidden" name="id" value="{$ns.recipientOrder->getId()}"/>
</form>
{else}
